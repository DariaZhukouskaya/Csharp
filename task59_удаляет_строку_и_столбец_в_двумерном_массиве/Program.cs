...
Напииште программу, которая удалит строку и столбец на пересечении которых расположен наименьший элемент массива.
Например:
1 4 7 2 
5 9 2 3
8 4 2 4
5 2 6 7
Наименьший элемент -1, на входе получим след массив:
9 2 3
4 2 4
2 6 7
*/
